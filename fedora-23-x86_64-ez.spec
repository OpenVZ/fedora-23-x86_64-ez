...
%changelog
* Mon Oct 31 2016 Konstantin Volkov <wolf@virtuozzo.com> 7.0.0-10
- Remove docker app template

* Fri Oct 28 2016 Konstantin Volkov <wolf@virtuozzo.com> 7.0.0-9
- Open tcp port for mod_ssl, see #PSBM-54473

* Thu Oct 27 2016 Konstantin Volkov <wolf@virtuozzo.com> 7.0.0-8
